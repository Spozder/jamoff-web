<template>
  ...
  >
    ...
    <span
      :class="
        tag === 'router-link' ? 'nav-link-inner--text' : 'btn-inner--text'
      "
...
export default {
  ...
  props: {
    ...
    faIcon: {
      type: Array,
      description: "Font Awesome Button icon"
    },
    text: {
      type: String,
      default: "",
    ...
    fa: {
      type: Boolean,
      default: false,
      description: "Whether the given icon is a font-awesome icon"
    },
    to: {
      type: String,
      default: "",
      description: "To-link for router-links"
    }
  },
  computed: {
    classes() {
